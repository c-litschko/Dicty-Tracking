...
The tool and it's associated files are licensed under the [MIT license](LICENSE). Dicty Tracking was made publically available on **[figshare](https://doi.org/10.6084/m9.figshare.5024552)** and can be cited as

>	Litschko C (2017) Dicty Tracking: A standalone tool for fast and easy tracking of migrating Dictyostelium cells. figshare. DOI: 10.6084/m9.figshare.5024552
