...
newunit = InputBox("Please enter the designation of the new speed unit. Thanks!", "new speed unit designation")
...
For track = 1 To Worksheets("Zwischenwerte").Cells(1, 2).Value
    For frame = 2 To Worksheets("Zwischenwerte").Cells(2, 2).Value
        ...
        Worksheets("Zwischenwertespeed").Cells(track + 1, frame - 1) = Worksheets("track data").Cells(frame + 1 + lastval * (track - 1), 9) * speedfactor
    Next frame
Next track
...
For frame = 2 To Worksheets("Zwischenwerte").Cells(2, 2).Value
    ...
    Worksheets("speed").Cells(frame, 2) = Worksheets("track data").Cells(frame + 1, 3)
...
For track = 1 To Worksheets("Zwischenwerte").Cells(1, 2).Value
    ...
    For frame = 2 To Worksheets("Zwischenwerte").Cells(2, 2).Value
        Worksheets("Zwischenwertespeed").Cells(frame, track) = Worksheets("track data").Cells(frame + 1 + lastval * (track - 1), 9) * speedfactor
    Next frame
Next track
