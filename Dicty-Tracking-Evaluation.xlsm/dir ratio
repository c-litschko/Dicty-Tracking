...
For row = 1 To Worksheets("Zwischenwerte").Cells(3, 2).Value
    Worksheets("dir ratio").Cells(row + 1, 1) = Worksheets("track data").Cells(row + 1, 1)
    Worksheets("dir ratio").Cells(row + 1, 2) = Worksheets("track data").Cells(row + 1, 2)
    Worksheets("dir ratio").Cells(row + 1, 3) = Worksheets("track data").Cells(row + 1, 3)
Next row
...
For track = 1 To Worksheets("Zwischenwerte").Cells(1, 2).Value
    For frame = 2 To Worksheets("Zwischenwerte").Cells(2, 2).Value
        ...
        D2S = Worksheets("track data").Cells(rownum, 8)
        Leng = Worksheets("track data").Cells(rownum, 7)
        If D2S = 0 Then
